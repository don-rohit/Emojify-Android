...
class Emojifier {
    ...
    static Bitmap detectfacesAndOverlayEmoji(Context context, Bitmap picture)
    {
        ...
        // Toast the number of faces
        Toast.makeText(context, "Faces Detected " + faces.size() , Toast.LENGTH_SHORT).show();
        if(faces.size() == 0)
    ...
    public static Emoji whichEmoji(Face face) {
        // probability of smiling and eye being open
        // Log all the probabilities
        Log.d(Emojifier.class.getSimpleName(), "getClassifications: smilingProb = " + face.getIsSmilingProbability());
        Log.d(Emojifier.class.getSimpleName(), "getClassifications: leftEyeOpenProb = " + face.getIsLeftEyeOpenProbability());
        Log.d(Emojifier.class.getSimpleName(), "getClassifications: rightEyeOpenProb = " + face.getIsRightEyeOpenProbability());
        ...
        Log.d(Emojifier.class.getSimpleName(), "whichEmoji: " + emoji.name());
